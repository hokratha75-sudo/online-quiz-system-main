...
<div class="max-w-[1400px] mx-auto p-8 md:p-10 font-inter text-slate-900">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
            ...
            <p class="text-[10px] font-bold text-indigo-600 mt-2 uppercase tracking-widest leading-none">Manage and reuse questions across all assessment sectors</p>
        </div>
    </div>
            ...
            <table class="w-full text-left border-collapse whitespace-nowrap" id="bankTable">
                <thead>
                    <tr class="bg-slate-50/10 border-b border-slate-50">
                        <th width="80" class="ps-8 py-5 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Sync ID</th>
                        <th class="px-6 py-5 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Question Index</th>
                        <th class="px-6 py-5 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Source Domain</th>
                        <th class="px-6 py-5 text-[10px] font-bold text-slate-500 uppercase tracking-widest text-center">Type</th>
                        <th class="px-6 py-5 text-[10px] font-bold text-slate-500 uppercase tracking-widest text-center">Weight</th>
                        <th width="120" class="pe-8 py-5 text-[10px] font-bold text-slate-500 uppercase tracking-widest text-right">Admin</th>
                    </tr>
                </thead>
                        ...
                        <tr class="hover:bg-slate-50/50 transition-all group">
                            ...
                            <td class="pe-8 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <button class="w-8 h-8 rounded-lg border border-slate-100 bg-white text-slate-400 hover:text-rose-600 hover:border-rose-100 hover:bg-rose-50 transition-all shadow-sm flex items-center justify-center">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="py-32 text-center">
                                ...
                                <h4 class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Question Bank Empty</h4>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
