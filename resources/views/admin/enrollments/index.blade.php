...
<div class="min-h-screen bg-slate-50/50 text-slate-900 p-6 md:p-10 font-inter">
    ...
    <div class="mb-10">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
                <h1 class="text-2xl font-bold text-slate-900 tracking-tight mb-2">Enrollment Management</h1>
    ...
    <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm shadow-slate-100">
        ...
        <div class="px-8 py-6 border-b border-slate-100 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            <div class="flex items-center gap-4">
                ...
                <div class="px-3 py-1 bg-indigo-50 text-indigo-600 text-[10px] font-bold uppercase tracking-widest rounded-full border border-indigo-100">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-all group">
                        ...
                        <td class="pe-8 py-6 text-right">
                            <a href="{{ route('admin.enrollments.manage', $department->id) }}" class="inline-flex items-center h-8 px-4 rounded-lg border border-slate-200 bg-white hover:border-indigo-600 hover:bg-indigo-50 text-slate-600 hover:text-indigo-600 text-[10px] font-bold uppercase tracking-widest transition-all group/btn shadow-sm no-underline">
                                <span>Manage</span>
