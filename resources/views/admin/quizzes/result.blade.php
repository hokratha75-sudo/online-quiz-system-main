        ...
        <div class="card animate-slide-up" style="animation-delay: 0.3s">
            <div class="card-body">
                <div class="flex flex-col sm:flex-row gap-3 justify-center">
                    <a href="{{ $isStudent ? route('students.dashboard') : (auth()->user()->isAdmin() ? route('admin.quizzes.index') : route('teacher.quizzes.index')) }}" 
                    ...
                    <a href="{{ $isStudent ? route('students.quizzes.take', $attempt->quiz_id) : (auth()->user()->isAdmin() ? route('admin.quizzes.show', $attempt->quiz_id) : route('teacher.quizzes.show', $attempt->quiz_id)) }}" 
