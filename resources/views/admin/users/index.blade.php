...
<div class="max-w-[1400px] mx-auto p-6 md:p-10 font-inter text-slate-900 bg-slate-50/30 min-h-screen">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        <div>
            <h1 class="text-3xl font-bold text-slate-900 tracking-tight leading-none">School Community</h1>
            <p class="text-sm font-medium text-slate-400 mt-2">Manage everyone who uses the app, from teachers to students.</p>
        </div>
        <div class="flex items-center gap-4">
            <button type="button" data-bs-toggle="modal" data-bs-target="#createUserModal" class="bg-indigo-600 hover:bg-indigo-700 text-white px-7 py-3 rounded-2xl text-xs font-bold transition-all flex items-center gap-3 shadow-xl shadow-indigo-600/20 active:scale-[0.98] uppercase tracking-widest">
    ...
    <div class="mb-10 bg-white border border-emerald-100 rounded-[24px] p-6 flex items-center justify-between shadow-xl shadow-emerald-500/5 relative overflow-hidden">
        ...
        <div class="flex items-center gap-5">
            ...
            <div>
                <h4 class="text-base font-bold text-slate-900 leading-tight">Action Successful</h4>
...
<div class="modal fade" id="createUserModal" tabindex="-1" aria-labelledby="createUserModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" id="createUserModalDialog" style="max-width: 950px;">
        <div class="modal-content border-0 shadow-2xl bg-white rounded-[24px] overflow-hidden">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="username" value="{{ old('username') }}" required
                                           class="form-control px-4 py-3 bg-slate-50 border border-slate-300 rounded-xl text-sm focus:bg-white focus:border-indigo-600 transition-all shadow-none"
                                ...
                                <div>
                                    ...
                                    <input type="password" name="password" required
                                           class="w-full px-4 py-3 bg-slate-50 border border-slate-300 rounded-xl text-sm focus:bg-white focus:border-indigo-600 transition-all outline-none"
                                           placeholder="••••••••">
                                </div>
                                <div>
                            ...
                            <div class="space-y-4">
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select name="sex" class="form-select px-4 py-3 bg-slate-50 border border-slate-300 rounded-xl text-sm focus:bg-white focus:border-indigo-600 transition-all shadow-none cursor-pointer">
                                    ...
                                    <div>
                                        ...
                                        <select name="role_id" class="form-select px-4 py-3 bg-slate-50 border border-slate-300 rounded-xl text-sm focus:bg-white focus:border-indigo-600 transition-all shadow-none cursor-pointer">
                                ...
                                <div>
                                    ...
                                    <div class="relative group cursor-pointer">
                                        ...
                                        <div class="w-full px-4 py-6 border-2 border-dashed border-slate-300 rounded-xl flex flex-col items-center gap-2 group-hover:border-indigo-600 transition-colors bg-slate-50/50" id="photoPreview">
                                            <i class="fas fa-cloud-arrow-up text-2xl text-slate-300 group-hover:text-indigo-600 transition-colors"></i>
