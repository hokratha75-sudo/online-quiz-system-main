...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $tables = [
            'class_subject', 'class_user', 'student_answers', 'results', 'attempts', 'answers', 'questions', 
            'quizzes', 'class_models', 'majors', 'subjects', 'departments', 
            'users', 'roles', 'activity_log', 'cache', 'cache_locks', 
        ...
        Schema::create('users', function (Blueprint $table) {
            ...
            if (DB::getDriverName() === 'pgsql') {
                $table->raw('status user_status DEFAULT \'active\'');
            } else {
        ...
        Schema::create('quizzes', function (Blueprint $table) {
            ...
            if (DB::getDriverName() === 'pgsql') {
                $table->raw('status quiz_status DEFAULT \'draft\'');
            } else {
        ...
        Schema::create('questions', function (Blueprint $table) {
            ...
            if (DB::getDriverName() === 'pgsql') {
                $table->raw('difficulty question_difficulty DEFAULT \'medium\'');
            } else {
        ...
        Schema::create('attempts', function (Blueprint $table) {
            ...
            if (DB::getDriverName() === 'pgsql') {
                $table->raw('status attempt_status DEFAULT \'in_progress\'');
            } else {
    ...
    {
        $tables = [
            'results', 'attempts', 'answers', 'questions', 'quizzes', 
            'subjects', 'users', 'departments', 'roles'
        ];
