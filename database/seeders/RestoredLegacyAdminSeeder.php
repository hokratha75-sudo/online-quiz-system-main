...
class RestoredLegacyAdminSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Note: class_subject table was dropped in later migrations
        ...
        // Note: class_user table was dropped in later migrations
    ...
    private function upsertClass(
        ...
        $existing = DB::table('class_models')
            ->where('code', $code)
            ->first();
